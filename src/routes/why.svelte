...
<div class="flex-container">
    ...
    <div class="flex-item right">
        <img src="./CHEV.gif" alt="Chevrolet" class="img-responsive">
        <img src="/FORD.gif" alt="Ford" class="img-responsive">
        <img src="./GMC.gif" alt="GMC" class="img-responsive">
        <img src="./HONDA.gif" alt="Honda" class="img-responsive">
        <img src="./HYUND.gif" alt="Hyundai" class="img-responsive">
        <img src="./JEEP.gif" alt="JEEP" class="img-responsive">
        <img src="./NISSAN.gif" alt="Nissan" class="img-responsive">
        <img src="./RAM.gif" alt="RAM" class="img-responsive">
        <img src="./TOYOTA.gif" alt="Toyota" class="img-responsive">
        <div class="show">
...
<div class="container">
    <h3>Buy Your Next Car Faster</h3>
    <p>Prep your paperwork online, ahead of time.</p>
